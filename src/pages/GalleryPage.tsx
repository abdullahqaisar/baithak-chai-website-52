...
const GalleryPage = () => {
  ...
  const galleryItems: GalleryItem[] = [
    {
      id: 1,
      src: "/lovable-uploads/110d21db-9a75-4d67-a0b9-93c48deaee8a.png",
    ...
    {
      id: 2,
      src: "/lovable-uploads/c485bd56-0c13-4032-9c21-da684503d540.png",
    ...
    {
      id: 3,
      src: "/lovable-uploads/7d85d3de-e894-47ee-9e0e-f01d7e6566fc.png",
    ...
    {
      id: 4,
      src: "/lovable-uploads/62b35be7-4aa5-4329-be51-880fe3457700.png",
      alt: "Chai cups",
    ...
    {
      id: 5,
      src: "/lovable-uploads/96f24c07-b73f-4a98-a4d8-5b16130c9b72.png",
      alt: "Tea preparation",
    ...
    {
      id: 6,
      src: "/lovable-uploads/028b0290-521d-4f8c-890c-374b9a55e2f3.png",
      alt: "Tea cart",
    ...
    {
      id: 7,
      src: "/lovable-uploads/57e3d15b-bf50-48bf-980c-d0b0f033300c.png",
      alt: "Chai and books",
          ...
          <section className="mb-16">
            <div className="bg-chai-brown-light text-white rounded-xl p-8 text-center">
              ...
              <div className="flex justify-center space-x-6">
                <a href="https://www.facebook.com/share/18pPvctQHZ/" target="_blank" rel="noopener noreferrer" className="text-chai-cream hover:text-chai-orange-light">
                  <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/baithakchaii?igsh=aDhsaGZtczlramV4" target="_blank" rel="noopener noreferrer" className="text-chai-cream hover:text-chai-orange-light">
                  <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
